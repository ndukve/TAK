        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          {certs === null ? (
            Array.from({ length: 3 }).map((_, i) => (
              <div key={i} className="rounded-lg border border-zinc-200 dark:border-white/10 hud-glass p-5 hud-card">
            ...
            certs.map((c) => {
              ...
              return (
                <div key={c.name} className="hud-frame relative rounded-lg border border-zinc-200 dark:border-white/10 hud-glass p-5 hud-card">
                  <HudCorners />
                  ...
                  <div className={cn('inline-flex items-center gap-1.5 mt-2 px-2 py-0.5 rounded-lg border text-xs font-medium', badgeClass, textClass)}>
