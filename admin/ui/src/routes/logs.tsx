      ...
      <div className="p-6 flex flex-col h-full">
        ...
        <div className="flex items-center gap-3 mb-4">
          <select
            ...
            className="px-3 py-2 rounded-lg bg-zinc-200 dark:bg-zinc-950 border border-zinc-300 dark:border-white/10 text-zinc-900 dark:text-white text-sm focus:outline-none"
          >
            {SERVICES.map((s) => (
