...
<!-- Plaintext TCP input for internal services on the NetBird overlay (e.g. EFDI moon-pod).
     Assign its CoT to the same routing group as authenticated TAK clients. -->
<input _name="stdtcp" protocol="tcp" port="8087" coreVersion="2" group="{{getenv "TAK_USER_GROUP" "TAK-USERS"}}"/>
...
<scrubber enable="false" action="scrub"/>
</filter>
<buffer>
